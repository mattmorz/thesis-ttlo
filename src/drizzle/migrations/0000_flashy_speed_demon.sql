...
ALTER TABLE "activity_log" DROP CONSTRAINT IF EXISTS "fk_activity_application";--> statement-breakpoint
...
ALTER TABLE "activity_log" DROP CONSTRAINT IF EXISTS "fk_activity_phase";--> statement-breakpoint
...
ALTER TABLE "activity_log" DROP CONSTRAINT IF EXISTS "fk_activity_user";--> statement-breakpoint
...
ALTER TABLE "application_phase" DROP CONSTRAINT IF EXISTS "application_phase_application_id_fkey";--> statement-breakpoint
...
ALTER TABLE "auth_session" DROP CONSTRAINT IF EXISTS "fk_session_user";--> statement-breakpoint
...
ALTER TABLE "client_profile" DROP CONSTRAINT IF EXISTS "client_profile_verified_by_fkey";--> statement-breakpoint
...
ALTER TABLE "ip_application" DROP CONSTRAINT IF EXISTS "ip_application_client_id_fkey";--> statement-breakpoint
...
ALTER TABLE "ip_application" DROP CONSTRAINT IF EXISTS "ip_application_user_id_fkey";--> statement-breakpoint
...
ALTER TABLE "matrix_feature" DROP CONSTRAINT IF EXISTS "matrix_feature_matrix_id_fkey";--> statement-breakpoint
...
ALTER TABLE "matrix_prior_art" DROP CONSTRAINT IF EXISTS "matrix_prior_art_matrix_id_fkey";--> statement-breakpoint
...
ALTER TABLE "patent_basic_application" DROP CONSTRAINT IF EXISTS "patent_basic_application_disclosure_id_fkey";--> statement-breakpoint
...
ALTER TABLE "patent_matrix" DROP CONSTRAINT IF EXISTS "patent_matrix_patent_id_fkey";--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_ip_application_type" ON "ip_application" USING btree ("ip_type" text_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ix_ip_application_status" ON "ip_application" USING btree ("status" text_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ix_ip_application_type" ON "ip_application" USING btree ("ip_type" text_ops);--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_task_phase_id" ON "phase_task" USING btree ("phase_id" uuid_ops);