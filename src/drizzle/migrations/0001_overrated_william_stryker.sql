...
ALTER TABLE "activity_log" ALTER COLUMN "activity_type" DROP DEFAULT;--> statement-breakpoint
...
ALTER TABLE "ip_application" ALTER COLUMN "ip_type" DROP DEFAULT;--> statement-breakpoint
...
ALTER TABLE "account" DROP CONSTRAINT IF EXISTS "account_userId_user_account_id_fk";--> statement-breakpoint
...
ALTER TABLE "ip_application" DROP CONSTRAINT IF EXISTS "ck_progress";--> statement-breakpoint
