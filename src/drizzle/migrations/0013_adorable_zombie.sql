...
ALTER TABLE "task_assignment" DROP CONSTRAINT IF EXISTS "task_assignment_user_id_fkey";--> statement-breakpoint
...
ALTER TABLE "archives" DROP CONSTRAINT IF EXISTS "archives_application_id_unique";--> statement-breakpoint
ALTER TABLE "archives" ADD CONSTRAINT "archives_application_id_unique" UNIQUE("application_id");--> statement-breakpoint
ALTER TABLE "task_assignment" DROP CONSTRAINT IF EXISTS "task_assignment_task_id_user_id_key";--> statement-breakpoint
