...
ALTER TABLE "documents_verification" DROP CONSTRAINT IF EXISTS "documents_id_fkey";--> statement-breakpoint
...
ALTER TABLE "documents_verification" DROP CONSTRAINT IF EXISTS "documents_validated_by_fkey";--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_documents_validation" ON "documents_verification" USING btree ("validation_status" text_ops);--> statement-breakpoint
ALTER TABLE "documents" DROP CONSTRAINT IF EXISTS "documents_project_id_fkey";--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_ip_app_notification_read" ON "ip_application_notification" USING btree ("is_read" bool_ops);--> statement-breakpoint
...
ALTER TABLE "other_documents" DROP CONSTRAINT IF EXISTS "other_documents_status_check";--> statement-breakpoint
