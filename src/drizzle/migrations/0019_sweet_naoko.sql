...
ALTER TABLE "substantial_use" DROP CONSTRAINT IF EXISTS "substantial_use_application_id_fkey";--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_substantial_use_application" ON "substantial_use" USING btree ("application_id" uuid_ops);--> statement-breakpoint
ALTER TABLE "application_phase" DROP CONSTRAINT IF EXISTS "ck_phase_status";--> statement-breakpoint
