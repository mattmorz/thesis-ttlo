ALTER TABLE "substantial_use" DROP CONSTRAINT "substantial_use_application_id_ip_application_id_fk";
...
CREATE INDEX "idx_deed_of_assignment_application" ON "deed_of_assignment" USING btree ("application_id" uuid_ops);