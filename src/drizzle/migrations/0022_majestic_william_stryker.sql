...
ALTER TABLE "ip_disclosure" DROP CONSTRAINT IF EXISTS "ip_disclosure_application_id_fkey";--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_ip_disclosure_application" ON "ip_disclosure" USING btree ("application_id" uuid_ops);--> statement-breakpoint
ALTER TABLE "application_phase" DROP CONSTRAINT IF EXISTS "ck_phase_status";--> statement-breakpoint
