ALTER TABLE "client_profile" DROP CONSTRAINT "unique_user_application_profile";--> statement-breakpoint
ALTER TABLE "client_profile" DROP CONSTRAINT "client_profile_application_id_fkey";
