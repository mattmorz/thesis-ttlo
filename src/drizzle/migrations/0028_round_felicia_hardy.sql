...
ALTER TABLE "client_profile" DROP CONSTRAINT IF EXISTS "client_profile_ip_application_id_fkey";--> statement-breakpoint
...
ALTER TABLE "client_profile" DROP CONSTRAINT IF EXISTS "unique_client_profile_per_application";--> statement-breakpoint
