...
import {
  ...
  internalValidation,
  ipApplicationNotification,
  ipDisclosureAttachment,
  otherDocuments,
  patentMatrixSample,
...
export const documentsValidationRelations = relations(
  documentsValidation,
  ({ one }) => ({
...
export const formSubmissionRegistryRelations = relations(
  formSubmissionRegistry,
  ({ one, many }) => ({
    ipApplication: one(ipApplication, {
...
export const disclosureConfirmationRelations = relations(
  disclosureConfirmation,
  ({ one }) => ({
    ipDisclosure: one(ipDisclosure, {
...
export const formDataMappingRelations = relations(
  formDataMapping,
  ({ one }) => ({
...
export const ipDisclosureApplicantRelations = relations(
  ipDisclosureApplicant,
  ({ one }) => ({
    ipDisclosure: one(ipDisclosure, {
...
export const ipApplicationNotificationRelations = relations(
  ipApplicationNotification,
  ({ one }) => ({
    userAccount: one(userAccount, {
...
export const ipDisclosureAttachmentRelations = relations(
  ipDisclosureAttachment,
  ({ one }) => ({
    ipDisclosure: one(ipDisclosure, {
...
export const patentMatrixSampleRelations = relations(
  patentMatrixSample,
  ({ one }) => ({
    ipDisclosure: one(ipDisclosure, {
...
export const patentUtilityModelApplicationRelations = relations(
  patentUtilityModelApplication,
  ({ one, many }) => ({
    patentMatrixSamples: many(patentMatrixSample),
    patentSearchReports: many(patentSearchReport),
...
export const ipDisclosureReviewRelations = relations(
  ipDisclosureReview,
  ({ one }) => ({
    ipDisclosure: one(ipDisclosure, {
...
export const patentSearchReportRelations = relations(
  patentSearchReport,
  ({ one }) => ({
    ipDisclosure: one(ipDisclosure, {
...
export const trademarkApplicationRelations = relations(
  trademarkApplication,
  ({ one }) => ({
    ipDisclosure: one(ipDisclosure, {
...
export const ipDisclosureInventorRelations = relations(
  ipDisclosureInventor,
  ({ one }) => ({
    ipDisclosure: one(ipDisclosure, {
